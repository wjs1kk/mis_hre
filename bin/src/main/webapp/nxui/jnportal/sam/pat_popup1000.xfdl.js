(function()
{
    return function()
    {
        ...
        {
            this.set_name("Popup1000");
            this.set_titletext("Popup1000");
            if (Form == this.constructor)
            {
                this._setFormPosition(1000,615);
            }
            ...
            obj = new Div("Div00","0","0","1000","615",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("");
            ...
            obj = new Div("div_Search","30","70","940","102",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("5");
            ...
            obj = new Static("sch_RQST_NO","0","15","120","26",null,null,null,null,null,null,this.Div00.form.div_Search.form);
            obj.set_taborder("2");
            obj.set_text("신청번호");
            ...
            obj = new Static("sch_RQST_DT","33.33%","15","120","26",null,null,null,null,null,null,this.Div00.form.div_Search.form);
            obj.set_taborder("4");
            obj.set_text("신청일");
            obj.set_cssclass("sta_WF_condition01");
            this.Div00.form.div_Search.addChild(obj.name, obj);
            ...
            obj = new Static("sch_RQST_DT00","66.66%","15","120","26",null,null,null,null,null,null,this.Div00.form.div_Search.form);
            obj.set_taborder("6");
            obj.set_text("신청자");
            obj.set_cssclass("sta_WF_condition01");
            this.Div00.form.div_Search.addChild(obj.name, obj);
            ...
            obj = new Static("sch_LAST_UPT_NM","0","49","120","26",null,null,null,null,null,null,this.Div00.form.div_Search.form);
            obj.set_taborder("12");
            obj.set_text("최종수정자");
            obj.set_cssclass("sta_WF_condition01");
            obj.set_usedecorate("true");
            ...
            obj = new Static("sch_LAST_UPT_DT","33.33%","49","120","26",null,null,null,null,null,null,this.Div00.form.div_Search.form);
            obj.set_taborder("13");
            obj.set_text("최종수정일");
            obj.set_cssclass("sta_WF_condition01");
            this.Div00.form.div_Search.addChild(obj.name, obj);

            obj = new Calendar("SCH_LAST_UPT_DT","sch_LAST_UPT_DT:10","49","117","26",null,null,null,null,null,null,this.Div00.form.div_Search.form);
            obj.set_taborder("9");
            ...
            obj = new Static("sch_DEPT_CD","66.66%","49","120","26",null,null,null,null,null,null,this.Div00.form.div_Search.form);
            obj.set_taborder("14");
            obj.set_text("신청부서");
            obj.set_cssclass("sta_WF_condition01");
            this.Div00.form.div_Search.addChild(obj.name, obj);
            ...
            obj = new Edit("SCH_LAST_UPT_NM","sch_LAST_UPT_NM:10","46","180","26",null,null,null,null,null,null,this.Div00.form.div_Search.form);
            obj.set_taborder("8");
            obj.set_cssclass("essential");
            this.Div00.form.div_Search.addChild(obj.name, obj);
            ...
            obj = new Static("Static15","0","72",null,"15","0",null,null,null,null,null,this.Div00.form.div_Search.form);
            obj.set_taborder("16");
            obj.set_text("h 15");
            obj.set_visible("false");
            obj.set_background("aqua");
            ...
            obj = new Static("Static12","118","15","10","57",null,null,null,null,null,null,this.Div00.form.div_Search.form);
            obj.set_taborder("17");
            obj.set_text("w 10");
            obj.set_visible("false");
            obj.set_background("fuchsia");
            ...
            obj = new Static("Static12_00","sch_RQST_DT:0","15","10","57",null,null,null,null,null,null,this.Div00.form.div_Search.form);
            obj.set_taborder("18");
            obj.set_text("w 10");
            obj.set_visible("false");
            obj.set_background("fuchsia");
            ...
            obj = new Static("Static12_00_00","sch_RQST_DT00:0","15","10","57",null,null,null,null,null,null,this.Div00.form.div_Search.form);
            obj.set_taborder("19");
            obj.set_text("w 10");
            obj.set_visible("false");
            obj.set_background("fuchsia");
            ...
            obj = new Static("Static12_00_00_00","908","10","0","26",null,null,null,null,null,null,this.Div00.form.div_Search.form);
            obj.set_taborder("20");
            obj.set_text("w 5");
            obj.set_visible("false");
            obj.set_background("fuchsia");
            ...
            obj = new Static("Static14","0","41",null,"8","1",null,null,null,null,null,this.Div00.form.div_Search.form);
            obj.set_taborder("21");
            obj.set_text("h 8");
            obj.set_visible("false");
            obj.set_background("aqua");
            ...
            obj = new Div("div_Search02_00","30","171","940","162",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("6");
            ...
            obj = new Static("Static20_00","21","111",null,"34","20",null,null,null,null,null,this.Div00.form.div_Search02_00.form);
            obj.set_taborder("4");
            obj.set_cssclass("sta_WF_condition02box");
            this.Div00.form.div_Search02_00.addChild(obj.name, obj);

            obj = new Static("in_YY","20","111","15.99%","34",null,null,null,null,null,null,this.Div00.form.div_Search02_00.form);
            obj.set_taborder("5");
            obj.set_text("Spinner");
            obj.set_cssclass("sta_WF_condition02_L");
            this.Div00.form.div_Search02_00.addChild(obj.name, obj);

            obj = new Static("Static11_00","20","45","15.99%","34",null,null,null,null,null,null,this.Div00.form.div_Search02_00.form);
            obj.set_taborder("6");
            obj.set_text("신청번호");
            obj.set_cssclass("sta_WF_condition02_L");
            this.Div00.form.div_Search02_00.addChild(obj.name, obj);

            obj = new Static("Static05_00","50.00%","111","15.99%","34",null,null,null,null,null,null,this.Div00.form.div_Search02_00.form);
            obj.set_taborder("7");
            obj.set_text("기간입력");
            obj.set_cssclass("sta_WF_condition02");
            this.Div00.form.div_Search02_00.addChild(obj.name, obj);

            obj = new Static("Static25","50.00%","78","15.99%","34",null,null,null,null,null,null,this.Div00.form.div_Search02_00.form);
            obj.set_taborder("8");
            obj.set_text("readonly");
            obj.set_cssclass("sta_WF_condition02");
            this.Div00.form.div_Search02_00.addChild(obj.name, obj);

            obj = new Static("Static23","20","78","15.99%","34",null,null,null,null,null,null,this.Div00.form.div_Search02_00.form);
            obj.set_taborder("9");
            obj.set_text("콤보입력");
            obj.set_cssclass("sta_WF_condition02_L");
            this.Div00.form.div_Search02_00.addChild(obj.name, obj);

            obj = new Static("Static22","50.00%","45","15.99%","34",null,null,null,null,null,null,this.Div00.form.div_Search02_00.form);
            obj.set_taborder("10");
            obj.set_text("필수입력");
            obj.set_cssclass("sta_WF_condition02");
            this.Div00.form.div_Search02_00.addChild(obj.name, obj);
            ...
            obj = new Static("Static00_00_00","in_YY:10","112","261","34",null,null,null,null,null,null,this.Div00.form.div_Search02_00.form);
            obj.set_taborder("13");
            obj.set_text("ACT02202001-00");
            this.Div00.form.div_Search02_00.addChild(obj.name, obj);
            ...
            obj = new Static("Static00_00_00_00","Static05_00:10","112","261","34",null,null,null,null,null,null,this.Div00.form.div_Search02_00.form);
            obj.set_taborder("15");
            obj.set_text("ACT02202001-00");
            this.Div00.form.div_Search02_00.addChild(obj.name, obj);

            obj = new Static("Static00_01","Static23:10","79","261","34",null,null,null,null,null,null,this.Div00.form.div_Search02_00.form);
            obj.set_taborder("16");
            obj.set_text("ACT02202001-00");
            this.Div00.form.div_Search02_00.addChild(obj.name, obj);
            ...
            obj = new Static("Static12","169","46","10","101",null,null,null,null,null,null,this.Div00.form.div_Search02_00.form);
            obj.set_taborder("18");
            obj.set_text("w 10");
            obj.set_visible("false");
            obj.set_background("fuchsia");
            ...
            obj = new Static("Static12_00","618","46","10","101",null,null,null,null,null,null,this.Div00.form.div_Search02_00.form);
            obj.set_taborder("19");
            obj.set_text("w 10");
            obj.set_visible("false");
            obj.set_background("fuchsia");
            ...
            obj = new Static("Static04_00_00_01","20","145","100","15",null,null,null,null,null,null,this.Div00.form.div_Search02_00.form);
            obj.set_taborder("21");
            obj.set_text("h 15");
            obj.set_visible("false");
            obj.set_background("aqua");
            ...
            obj = new Div("div_Search02_00_00","30","343","940","196",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("7");
            obj.set_cssclass("div_WF_popup");
            obj.set_text("");
            this.Div00.addChild(obj.name, obj);
            ...
            obj = new Static("Static07_00","30","333","80","10",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("10");
            obj.set_text("h 10");
            obj.set_visible("false");
            obj.set_background("aqua");
        ...
        this.loadIncludeScript("pat_popup1000.xfdl");
