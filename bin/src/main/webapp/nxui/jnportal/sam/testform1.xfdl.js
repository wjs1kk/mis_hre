(function()
{
    return function()
    {
        ...
        {
            this.set_name("testform1");
            this.set_titletext("Type2 템플릿");
            ...
            obj = new Button("btnExportCompML",null,"19","160","28","186",null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Button("btn_registration",null,"19","90","28","349",null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("신규등록");
            obj.set_cssclass("btn_WF_icoRegistration");
            this.addChild(obj.name, obj);

            obj = new Button("btn_001",null,"19","90","28","442",null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("NullPoint");
            ...
            obj = new Layout("default","",0,0,this.divResult.form,
                ...
                p.grdTypeTwo.set_autoupdatetype("itemselect");
            ...
            obj = new Layout("default","Desktop_screen",1280,670,this,
                ...
                p.btnExportCompML.set_taborder("2");
                p.btnExportCompML.set_text("Export 컴포넌트 언어 Data");
                p.btnExportCompML.move(null,"19","160","28","186",null);
                ...
                p.Static04_00_00.set_taborder("5");
                ...
                p.Static04_00_00_01.set_taborder("7");
                ...
                p.btnSearch.set_taborder("9");
                p.btnSearch.move(null,"19","65","28","118",null);

                p.btn_registration.set_taborder("10");
                p.btn_registration.set_text("신규등록");
                p.btn_registration.set_cssclass("btn_WF_icoRegistration");
                p.btn_registration.move(null,"19","90","28","349",null);

                p.btn_001.set_taborder("11");
                p.btn_001.set_text("NullPoint");
                p.btn_001.set_cssclass("btn_WF_icoContDelete");
                p.btn_001.move(null,"19","90","28","442",null);
            	}
            );
        ...
        // User Script
        this.addIncludeScript("testform1.xfdl","lib::common.xjs");
        this.registerScript("testform1.xfdl", function() {
        /**
        *  Type2 Template
        *  MenuPath      -
        ...
        */
        this.btn_001_onclick = function(obj,e)
        {
        ...
        ************************************************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.btn_001.addEventHandler("onclick",this.btn_001_onclick,this);
        };
        this.loadIncludeScript("testform1.xfdl");
