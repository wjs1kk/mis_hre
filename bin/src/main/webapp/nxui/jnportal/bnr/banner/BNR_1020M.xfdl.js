(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"48\" band=\"left\"/><Column size=\"220\"/><Column size=\"444\"/><Column size=\"99\"/><Column size=\"100\"/><Column size=\"80\"/><Column size=\"100\"/></Columns><Rows><Row size=\"23\" band=\"head\"/><Row size=\"23\" band=\"head\"/><Row size=\"33\"/></Rows><Band id=\"head\"><Cell rowspan=\"2\" text=\"순번\"/><Cell col=\"1\" rowspan=\"2\" text=\"배너명\"/><Cell col=\"2\" rowspan=\"2\" text=\"배너URL\"/><Cell col=\"3\" rowspan=\"2\" text=\"등록자\"/><Cell col=\"4\" rowspan=\"2\" text=\"등록일\"/><Cell col=\"5\" rowspan=\"2\" text=\"우선순위\"/><Cell col=\"6\" rowspan=\"2\" text=\"사용여부\" edittype=\"readonly\"/></Band><Band id=\"body\"><Cell expr=\"currow+1\" text=\"expr:currow+1\" textAlign=\"center\"/><Cell col=\"1\" text=\"bind:bnrNm\"/><Cell col=\"2\" text=\"bind:bnrUrl\"/><Cell col=\"3\" text=\"bind:rgstrId\"/><Cell col=\"4\" text=\"bind:rgstDt\"/><Cell col=\"5\" text=\"bind:bnrOrd\"/><Cell col=\"6\" text=\"bind:useYn\" displaytype=\"checkboxcontrol\" checkboxfalsevalue=\"N\" checkboxtruevalue=\"Y\"/></Band></Format></Formats>");
        ...
        */
        ...
        this.divResult_grdList_oncelldblclick = function(obj,e)
        {
        	...
        	nexacro.getApplication().openNewTab("BNR_1010M", "배너 등록", "bnr::banner/BNR_1010M.xfdl", param , "관리메뉴 > 관리자 > 배너 추가", "advtManage");
        };
        ...
        */
        this.divResult_btn_grdAdd_onclick = function(obj,e)
        {
        	...
        	var url = "bnr::banner/BNR_1010M.xfdl";
        	/*var url ="mif::myPage/MIF_2010M.xfdl";*/
        	nexacro.getApplication().openNewTab(sMenuId, "배너 조회", url , "", "관리메뉴 > 관리자 > 배너 및 팝업관리", "advtManage");
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.cboType.addEventHandler("ondropdown",this.div_Search_sch_apv_stat_cd_ondropdown,this);
            this.divSearch.form.cboType.addEventHandler("oncloseup",this.div_Search_sch_apv_stat_cd_oncloseup,this);
            this.divSearch.form.cboType.addEventHandler("onitemchanged",this.div_Search_sch_apv_stat_cd_onitemchanged,this);
