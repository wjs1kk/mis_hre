(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("boardManage.xfdl","lib::common.xjs");
        this.registerScript("boardManage.xfdl", function() {
        /**
        *  게시판 관리
        *  MenuPath      관리 메뉴 - 관리자 - 게시판 관리
        *  FileName      boardManage.xfdl
        *  Creator 	     parksw
        ...
        ************************************************************************************************/
        ...
        this.fnOpenRegistPopup = function (sysId, boardId) {
            ...
            this.gfnOpenPopup("boardRegistPopup", "cms::boardRegistPopup.xfdl", args, "fnPopupCallback", "");
        };
        ...
        this.loadIncludeScript("boardManage.xfdl");
