(function()
{
    return function()
    {
        ...
        {
            this.set_name("myMemberManagePopup");
            ...
            obj = new Static("Static00_00","395","85","416","26",null,null,null,null,null,null,this.divPopup.form.divForm.form);
            obj.set_taborder("27");
            ...
            obj = new Static("Static01_00_00_00_00","109","77","25","34",null,null,null,null,null,null,this.divPopup.form.divForm.form);
            obj.set_taborder("28");
            obj.set_text("*");
            obj.set_cssclass("essential");
            ...
            obj = new Static("Static01_00_00_00_00_00","139","111","25","34",null,null,null,null,null,null,this.divPopup.form.divForm.form);
            obj.set_taborder("29");
            obj.set_text("*");
            obj.set_cssclass("essential");
            obj.set_tooltiptext("필수입력");
            ...
            obj = new Static("Static01_00_00_00_00_01","124","41","25","34",null,null,null,null,null,null,this.divPopup.form.divForm.form);
            obj.set_taborder("30");
            obj.set_text("*");
            obj.set_cssclass("essential");
            obj.set_tooltiptext("필수입력");
            ...
            obj = new Button("btn_save","384",null,"65","28",null,"23",null,null,null,null,this.divPopup.form);
            obj.set_taborder("8");
            obj.set_text("저장");
            ...
            obj = new BindItem("item0","divPopup.form.divForm.form.edt_001","value","dsUserInfo","oldPasswd");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","divPopup.form.divForm.form.edt_001_00","value","dsUserInfo","passwd");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","divPopup.form.divForm.form.edt_001_00_00","value","dsUserInfo","passwd2");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("myMemberManagePopup.xfdl","lib::common.xjs");
        this.registerScript("myMemberManagePopup.xfdl", function() {
        /**
        *  Popup Template
        *  MenuPath      -
        ...
        */
         ...
         * description 저장버튼
        */
        this.divPopup_btn_save_onclick = function(obj,e)
        {
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.divPopup.form.btn_save.addEventHandler("onclick",this.divPopup_btn_save_onclick,this);
        };
        this.loadIncludeScript("myMemberManagePopup.xfdl");
