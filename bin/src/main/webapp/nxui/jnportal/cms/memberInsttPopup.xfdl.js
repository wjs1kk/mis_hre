(function()
{
    return function()
    {
        ...
        {
            this.set_name("memberInsttPopup");
            ...
            obj = new Static("Static07_00_00_00","20","45","1","106",null,null,null,null,null,null,this.divPopup.form.divForm.form);
            obj.set_taborder("5");
            ...
            obj = new Edit("edt_001","184","50","200","26",null,null,null,null,null,null,this.divPopup.form.divForm.form);
            obj.set_taborder("11");
            ...
            obj = new Button("btnSearch",null,"9","65","28","20",null,null,null,null,null,this.divPopup.form.divForm.form);
            obj.set_text("조회");
            obj.set_cssclass("btn_WF_icoSearch");
            obj.set_taborder("13");
            this.divPopup.form.divForm.addChild(obj.name, obj);

            obj = new Static("sta_001_00","21","81","150","34",null,null,null,null,null,null,this.divPopup.form.divForm.form);
            obj.set_taborder("14");
            obj.set_text("전체기관명");
            obj.set_cssclass("sta_WF_condition02");
            this.divPopup.form.divForm.addChild(obj.name, obj);

            obj = new Edit("edt_001_00","184","85","200","26",null,null,null,null,null,null,this.divPopup.form.divForm.form);
            obj.set_taborder("15");
            obj.set_maxlength("100");
            this.divPopup.form.divForm.addChild(obj.name, obj);
            ...
            obj = new Static("Static07_01_01_00_00_00","21","80",null,"1","21",null,null,null,null,null,this.divPopup.form.divForm.form);
            obj.set_taborder("17");
            obj.set_background("#dddddd");
            obj.set_text("");
            this.divPopup.form.divForm.addChild(obj.name, obj);
            ...
            obj = new Static("Static07_01_01_00_00_00_00","21","115",null,"1","21",null,null,null,null,null,this.divPopup.form.divForm.form);
            obj.set_taborder("19");
            obj.set_background("#dddddd");
            obj.set_text("");
            this.divPopup.form.divForm.addChild(obj.name, obj);

            obj = new Static("sta_001_00_00","21","116","150","34",null,null,null,null,null,null,this.divPopup.form.divForm.form);
            obj.set_taborder("20");
            obj.set_text("최하위기관명");
            obj.set_cssclass("sta_WF_condition02");
            this.divPopup.form.divForm.addChild(obj.name, obj);

            obj = new Static("Static07_01_01_00_01_00","21","150",null,"1","21",null,null,null,null,null,this.divPopup.form.divForm.form);
            obj.set_taborder("21");
            obj.set_background("#dddddd");
            obj.set_text("");
            this.divPopup.form.divForm.addChild(obj.name, obj);

            obj = new Edit("edt_001_00_00","184","120","200","26",null,null,null,null,null,null,this.divPopup.form.divForm.form);
            obj.set_taborder("22");
            obj.set_maxlength("100");
            this.divPopup.form.divForm.addChild(obj.name, obj);
            ...
            obj = new Static("Static00","405","85","416","26",null,null,null,null,null,null,this.divPopup.form.divForm.form);
            obj.set_taborder("28");
            ...
            obj = new Static("Static00_00","405","120","416","26",null,null,null,null,null,null,this.divPopup.form.divForm.form);
            obj.set_taborder("29");
            ...
            obj = new Button("btnReset",null,"9","65","28","90",null,null,null,null,null,this.divPopup.form.divForm.form);
            obj.set_text("초기화");
            obj.set_taborder("30");
            this.divPopup.form.divForm.addChild(obj.name, obj);
            ...
            obj = new Button("btn_add","384",null,"65","28",null,"23",null,null,null,null,this.divPopup.form);
            obj.set_taborder("8");
            obj.set_text("추가");
            ...
            obj = new Static("stc_gridRowCnt","120","7","149","27",null,null,null,null,null,null,this.divPopup.form.divResult.form);
            obj.set_taborder("1");
            obj.set_text("(총 0건)");
            ...
            obj = new BindItem("item0","divPopup.form.divForm.form.edt_001","value","dsSearch","searchInsttCode");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","divPopup.form.divForm.form.edt_001_00","value","dsSearch","allInsttNm");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","divPopup.form.divForm.form.edt_001_00_00","value","dsSearch","lowestInsttNm");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("memberInsttPopup.xfdl","lib::common.xjs");
        this.addIncludeScript("memberInsttPopup.xfdl","lib::paging.xjs");
        this.registerScript("memberInsttPopup.xfdl", function() {
        /**
        *  Popup Template
        *  MenuPath      -
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	*/
        	...
        	var objConfig = {
        						...
        						objSearchButton	: this.divPopup.form.divForm.form.btnSearch
        					}

        	this.fnInitPageSet(objdivPaging, objConfig);

        	this.btnSearch_onclick(this.divPopup.form.divForm.form.btnSearch);  // 조회버튼 object 반드시 지정
        };
        ...
        this.fnCallBack = function (sSvcId, nErrorCode, sErrorMsg)
        {
        	switch (sSvcId) {
        		case "getInsttList":
        			...
        			this.gfnAllRowCount(this.totRowCount, this.divPopup.form.divResult.form.stc_gridRowCnt);
        ...
        */
        this.divPopup_divForm_edt_001_onkillfocus = function(obj,e)
        {
        ...
        */
         ...
         * description 초기화 버튼
        */
        this.divPopup_divForm_btnReset_onclick = function(obj,e)
        {
        ...
        ************************************************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.divPopup.form.divForm.form.edt_001.addEventHandler("onkillfocus",this.divPopup_divForm_edt_001_onkillfocus,this);
            this.divPopup.form.divForm.form.Static10_00_00_01_00.addEventHandler("onclick",this.div_Search_Static10_00_onclick,this);
            this.divPopup.form.divForm.form.btnSearch.addEventHandler("onclick",this.btn_search_onclick,this);
            this.divPopup.form.divForm.form.edt_001_00.addEventHandler("onkeyup",this.divPopup_divForm_edt_001_onkeyup,this);
            ...
            this.divPopup.form.divForm.form.edt_001_00_00.addEventHandler("onkeyup",this.divPopup_divForm_edt_001_onkeyup,this);
            ...
            this.divPopup.form.divForm.form.btnReset.addEventHandler("onclick",this.divPopup_divForm_btnReset_onclick,this);
            ...
            this.divPopup.form.btn_add.addEventHandler("onclick",this.btn_add_onclick,this);
        ...
        this.loadIncludeScript("memberInsttPopup.xfdl");
