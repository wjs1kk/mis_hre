(function()
{
    return function()
    {
        ...
        {
            this.set_name("statisticsUserPopup");
            ...
            obj = new Div("divForm","30","70",null,"94","30",null,null,null,null,null,this.divPopup.form);
            obj.set_taborder("4");
            ...
            obj = new Static("Static07_00_00_00","20","46","1","34",null,null,null,null,null,null,this.divPopup.form.divForm.form);
            obj.set_taborder("5");
            obj.set_background("#00388e");
            obj.set_text("");
            this.divPopup.form.divForm.addChild(obj.name, obj);

            obj = new Static("Static07_01_02_00","121","45","1","34",null,null,null,null,null,null,this.divPopup.form.divForm.form);
            obj.set_taborder("6");
            obj.set_background("#dddddd");
            this.divPopup.form.divForm.addChild(obj.name, obj);

            obj = new Static("in_YY","285","46","100","34",null,null,null,null,null,null,this.divPopup.form.divForm.form);
            obj.set_taborder("8");
            obj.set_text("사용자명");
            obj.set_cssclass("sta_WF_condition02");
            this.divPopup.form.divForm.addChild(obj.name, obj);

            obj = new Static("sta_001","21","46","100","34",null,null,null,null,null,null,this.divPopup.form.divForm.form);
            obj.set_taborder("9");
            obj.set_text("사용자 ID");
            obj.set_cssclass("sta_WF_condition02");
            this.divPopup.form.divForm.addChild(obj.name, obj);

            obj = new Static("Static10_00","122","46","12","34",null,null,null,null,null,null,this.divPopup.form.divForm.form);
            obj.set_taborder("10");
            obj.set_text("w12");
            obj.set_visible("false");
            obj.set_background("fuchsia");
            ...
            obj = new Static("Static10_00_00_00","386","46","12","34",null,null,null,null,null,null,this.divPopup.form.divForm.form);
            obj.set_taborder("11");
            obj.set_text("w12");
            obj.set_visible("false");
            obj.set_background("fuchsia");
            ...
            obj = new Static("Static04_00_00_00_00","110","81","60","15",null,null,null,null,null,null,this.divPopup.form.divForm.form);
            obj.set_taborder("12");
            obj.set_text("h 15");
            obj.set_visible("false");
            obj.set_background("aqua");
            ...
            obj = new Edit("edt_001","134","50","120","26",null,null,null,null,null,null,this.divPopup.form.divForm.form);
            obj.set_taborder("13");
            ...
            obj = new Edit("edt_003","398","50","120","26",null,null,null,null,null,null,this.divPopup.form.divForm.form);
            obj.set_taborder("15");
            obj.set_maxlength("100");
            this.divPopup.form.divForm.addChild(obj.name, obj);

            obj = new Static("Static07_00_00_00_00","284","46","1","34",null,null,null,null,null,null,this.divPopup.form.divForm.form);
            obj.set_taborder("16");
            obj.set_background("#00388e");
            obj.set_text("");
            this.divPopup.form.divForm.addChild(obj.name, obj);

            obj = new Static("Static07_01_02_00_00","385","45","1","34",null,null,null,null,null,null,this.divPopup.form.divForm.form);
            obj.set_taborder("17");
            obj.set_background("#dddddd");
            this.divPopup.form.divForm.addChild(obj.name, obj);

            obj = new Static("Static10_00_00","254","0","30",null,null,"0",null,null,null,null,this.divPopup.form.divForm.form);
            obj.set_taborder("18");
            obj.set_text("w30");
            obj.set_visible("false");
            obj.set_background("fuchsia");
            ...
            obj = new Static("Static10_00_00_01","518","0","30",null,null,"0",null,null,null,null,this.divPopup.form.divForm.form);
            obj.set_taborder("19");
            obj.set_text("w30");
            obj.set_visible("false");
            obj.set_background("fuchsia");
            ...
            obj = new Static("Static10_00_00_01_00","818","8","20","84",null,null,null,null,null,null,this.divPopup.form.divForm.form);
            obj.set_taborder("20");
            obj.set_text("w20");
            obj.set_visible("false");
            obj.set_background("fuchsia");
            ...
            obj = new Static("stc_gridRowCnt","120","176","149","27",null,null,null,null,null,null,this.divPopup.form);
            obj.set_taborder("10");
            obj.set_text("(총 0건)");
            ...
            obj = new Static("Static09","30","175","169","27",null,null,null,null,null,null,this.divPopup.form);
            obj.set_taborder("12");
            obj.set_text("검색결과");
            obj.set_cssclass("sta_WF_subTitle01");
            this.divPopup.addChild(obj.name, obj);

            obj = new Grid("grdUser","30","209",null,null,"30","76",null,null,null,null,this.divPopup.form);
            obj.set_taborder("13");
            ...
            obj = new Button("btn_add","384","449","65","28",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("추가");
        ...
        // User Script
        this.addIncludeScript("statisticsUserPopup.xfdl","lib::common.xjs");
        this.registerScript("statisticsUserPopup.xfdl", function() {
        /**
        *  Popup Template
        *  MenuPath      -
        ...
        */
        this.fnCallBack = function (sSvcId, nErrorCode, sErrorMsg)
        {
        	switch (sSvcId) {
        		case "getUserList":
        			// 총 건수 계산
        			this.gfnRowCount(this.dsUser, this.divPopup.form.stc_gridRowCnt);
        		break;
        		default:
        		break;
        	}
        ...
        ************************************************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.divPopup.form.divForm.form.edt_001.addEventHandler("onkeyup",this.divPopup_divForm_edt_001_onkeyup,this);
            this.divPopup.form.divForm.form.edt_003.addEventHandler("onkeyup",this.divPopup_divForm_edt_001_onkeyup,this);
            this.divPopup.form.divForm.form.Static07_00_00_00_00.addEventHandler("onclick",this.div_Search_Static07_onclick,this);
            this.divPopup.form.divForm.form.Static07_01_02_00_00.addEventHandler("onclick",this.div_Search_Static07_onclick,this);
            this.divPopup.form.divForm.form.Static10_00_00.addEventHandler("onclick",this.div_Search_Static10_00_onclick,this);
            this.divPopup.form.divForm.form.Static10_00_00_01.addEventHandler("onclick",this.div_Search_Static10_00_onclick,this);
            ...
            this.divPopup.form.grdUser.addEventHandler("oncelldblclick",this.divPopup_grdUser_oncelldblclick,this);
            this.btn_add.addEventHandler("onclick",this.btn_add_onclick,this);
        };
        this.loadIncludeScript("statisticsUserPopup.xfdl");
