(function()
{
    return function()
    {
        ...
        {
            this.set_name("PTS_3060M_02");
            this.set_titletext("규정 및 지침_상세뷰");
            ...
            obj = new Div("Div00","180","0",null,"913","180",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("Div00");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static02","Static01:0","32","522","20",null,null,null,null,null,null,this.Div00.form.Div01.form.Div00_00.form);
            obj.set_taborder("1");
            obj.set_text("(훈령) 785 무기체계 부품국산화개발 관리규정_전문.hwp (312KB)");
            obj.set_enable("true");
            ...
            obj.set_text("\r\n부품국산화 지원사업 적용규정을 안내드립니다.");
            this.Div00.form.Div01.form.Div01.addChild(obj.name, obj);

            obj = new Button("Button02","743","Div01:20","75","45",null,null,null,null,null,null,this.Div00.form.Div01.form);
            obj.set_taborder("10");
            obj.set_text("목록");
            ...
            obj = new Static("Static02","Static03:54","13","355","30",null,null,null,null,null,null,this.Div00.form.Div01.form.Div02.form);
            obj.set_taborder("0");
            obj.set_text("국방기술 연구개발 업무처리 지침");
            obj.set_enable("true");
            ...
            obj = new Static("Static02","Static12:54","13","400","30",null,null,null,null,null,null,this.Div00.form.Div01.form.Div03.form);
            obj.set_taborder("0");
            obj.set_text("국방과학기술혁신 촉진법");
            obj.set_enable("true");
            obj.set_cssclass("portal_sta_pageTxt");
            this.Div00.form.Div01.form.Div03.addChild(obj.name, obj);

            obj = new Static("Static01","0","24","382","38",null,null,null,null,null,null,this.Div00.form.Div01.form);
            obj.set_taborder("4");
            obj.set_text("부품국산화 지원사업 적용규정");
            obj.set_enable("true");
        ...
        // User Script
        this.registerScript("PTS_3060M_02.xfdl", function() {
        ...
        this.loadIncludeScript("PTS_3060M_02.xfdl");
