(function()
{
    return function()
    {
        ...
        {
            this.set_name("PTS_3060M_01");
            this.set_titletext("규정 및 지침");
            if (Form == this.constructor)
            {
                this._setFormPosition(1920,1071);
            }
            ...
            obj._setContents("<ColumnInfo><Column id=\"col1\" type=\"STRING\" size=\"256\"/><Column id=\"col2\" type=\"STRING\" size=\"256\"/><Column id=\"col3\" type=\"STRING\" size=\"256\"/><Column id=\"col4\" type=\"STRING\" size=\"256\"/><Column id=\"col5\" type=\"STRING\" size=\"256\"/><Column id=\"col6\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"col2\">규정 및 지침관련 안내사항입니다.</Col><Col id=\"col3\">N</Col><Col id=\"col4\">2023.02.27</Col><Col id=\"col5\">Y</Col><Col id=\"col1\">10</Col><Col id=\"col6\">99</Col></Row><Row><Col id=\"col1\">9</Col><Col id=\"col2\">국방기술 연구개발 업무처리 지침</Col><Col id=\"col3\">Y</Col><Col id=\"col4\">2023.02.24</Col><Col id=\"col5\">N</Col><Col id=\"col6\">214</Col></Row><Row><Col id=\"col1\">8</Col><Col id=\"col2\">방위사업법</Col><Col id=\"col3\">Y</Col><Col id=\"col4\">2023.02.17</Col><Col id=\"col5\">N</Col><Col id=\"col6\">33</Col></Row><Row><Col id=\"col1\">7</Col><Col id=\"col2\">방위사업법 시행규칙</Col><Col id=\"col3\">Y</Col><Col id=\"col4\">2023.02.07</Col><Col id=\"col5\">N</Col><Col id=\"col6\">45</Col></Row><Row><Col id=\"col1\">6</Col><Col id=\"col2\">국방과학기술혁신 촉진법 시행령</Col><Col id=\"col3\">N</Col><Col id=\"col4\">2023.02.06</Col><Col id=\"col5\">N</Col><Col id=\"col6\">56</Col></Row><Row><Col id=\"col1\">5</Col><Col id=\"col2\">국방과학기술혁신 촉진법 시행규칙</Col><Col id=\"col3\">N</Col><Col id=\"col4\">2023.02.06</Col><Col id=\"col5\">N</Col><Col id=\"col6\">67</Col></Row><Row><Col id=\"col1\">4</Col><Col id=\"col2\">국방과학기술혁신 촉진법</Col><Col id=\"col3\">N</Col><Col id=\"col4\">2023.01.27</Col><Col id=\"col5\">N</Col><Col id=\"col6\">78</Col></Row><Row><Col id=\"col1\">3</Col><Col id=\"col2\">국방과학기술 정보관리 업무지침</Col><Col id=\"col3\">N</Col><Col id=\"col4\">2023.01.22</Col><Col id=\"col5\">N</Col><Col id=\"col6\">89</Col></Row><Row><Col id=\"col1\">2</Col><Col id=\"col2\">부품국산화 지원사업 적용규정</Col><Col id=\"col3\">N</Col><Col id=\"col4\">2023.01.21</Col><Col id=\"col5\">N</Col><Col id=\"col6\">99</Col></Row><Row><Col id=\"col1\">1</Col><Col id=\"col2\">부품국산화 지원사업 운영지침</Col><Col id=\"col3\">N</Col><Col id=\"col4\">2023.01.20</Col><Col id=\"col5\">N</Col><Col id=\"col6\">2134</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static01","0","Static00:0","62","88",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("1");
            obj.set_text("전체 <fc v=\'#213878\'>18</fc>건");
            obj.set_enable("true");
            ...
            obj = new Button("btnSearch",null,"Static00:25","60","38","0",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("2");
            obj.set_cssclass("portal_btn");
            obj.set_text("검색");
            this.Div00.addChild(obj.name, obj);

            obj = new Edit("Edit07",null,"152","150","38","btnSearch:10",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("3");
            obj.set_displaynulltext("검색어 입력");
            obj.set_cssclass("portal_edi_search");
            this.Div00.addChild(obj.name, obj);

            obj = new Combo("Combo00",null,"152","100","38","Edit07:10",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("4");
            ...
            obj = new Grid("Grid01","0","Static00:89",null,null,"0","65",null,null,null,null,this.Div00.form);
            obj.set_taborder("5");
            obj.set_binddataset("dsList");
            obj.set_tooltiptype("default");
            obj.set_autofittype("col");
            obj.set_cssclass("portal_grd_bdList");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"70\"/><Column size=\"1230\"/><Column size=\"80\"/><Column size=\"100\"/><Column size=\"80\"/></Columns><Rows><Row size=\"67\" band=\"head\"/><Row size=\"61\"/></Rows><Band id=\"head\"><Cell text=\"번호\"/><Cell col=\"1\" text=\"제목\"/><Cell col=\"2\" text=\"첨부파일\"/><Cell col=\"3\" text=\"등록일\"/><Cell col=\"4\" text=\"조회수\"/></Band><Band id=\"body\"><Cell text=\"expr:col5 ==&quot;Y&quot;?&quot;&quot;:col1\" cssclass=\"expr:col5 ==&quot;Y&quot;?&quot;notice&quot;:&quot;&quot;\"/><Cell col=\"1\" displaytype=\"text\" edittype=\"none\" text=\"bind:col2\" calendardateformat=\"yyyy-MM-dd\" textAlign=\"left\"/><Cell col=\"2\" displaytype=\"imagecontrol\" edittype=\"none\" cssclass=\"\" text=\"expr:col3==&quot;Y&quot;? &quot;theme://images/portal/portal_attach.png&quot;:&quot;&quot;\"/><Cell col=\"3\" displaytype=\"normal\" edittype=\"normal\" text=\"bind:col4\" calendardateformat=\"yyyy-MM-dd\"/><Cell col=\"4\" displaytype=\"normal\" edittype=\"normal\" text=\"bind:col6\"/></Band></Format></Formats>");
            this.Div00.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("PTS_3060M_01.xfdl", function() {
        ...
        {
        	var sMenuId = "PTS_3060M_02";
        	var url = "pts::PTS_3060M_02.xfdl";
        ...
        */
        ...
        this.loadIncludeScript("PTS_3060M_01.xfdl");
