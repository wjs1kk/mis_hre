(function()
{
    return function()
    {
        ...
        {
            this.set_name("PTS_3060M_03");
            this.set_titletext("규정 및 지침_글쓰기");
            ...
            obj = new Static("Static100","0","0",null,"51","0",null,null,null,null,null,this.Div00.form.Div01.form.Div00.form);
            obj.set_taborder("0");
            ...
            obj = new Static("Static01","0","0","200","51",null,null,null,null,null,null,this.Div00.form.Div01.form.Div00.form);
            obj.set_taborder("2");
            obj.set_text("제목");
            ...
            obj = new Edit("Edit01","Static01:10","9",null,"33","150",null,null,null,null,null,this.Div00.form.Div01.form.Div00.form);
            obj.set_taborder("3");
            obj.set_cssclass("portal_edi");
            this.Div00.form.Div01.form.Div00.addChild(obj.name, obj);

            obj = new Static("Static02","0","50","200","51",null,null,null,null,null,null,this.Div00.form.Div01.form.Div00.form);
            obj.set_taborder("4");
            obj.set_text("작성자");
            obj.set_font("normal bold 16px/normal \"맑은고딕\"");
            obj.set_cssclass("portal_sta_memLabel_L");
            ...
            obj = new Edit("Edit02","Static02:10","59","160","33",null,null,null,null,null,null,this.Div00.form.Div01.form.Div00.form);
            obj.set_taborder("5");
            ...
            obj = new Static("Static100_00_00_00","0","Static100:149",null,"51","0",null,null,null,null,null,this.Div00.form.Div01.form.Div00.form);
            obj.set_taborder("7");
            obj.set_cssclass("portal_sta_memLabelBg");
            obj.set_text("");
            this.Div00.form.Div01.form.Div00.addChild(obj.name, obj);

            obj = new Static("Static03","0","100","200","51",null,null,null,null,null,null,this.Div00.form.Div01.form.Div00.form);
            obj.set_taborder("8");
            obj.set_text("등록일");
            obj.set_font("normal bold 16px/normal \"맑은고딕\"");
            obj.set_cssclass("portal_sta_memLabel_L");
            ...
            obj = new Calendar("Calendar00","Static03:10","109","160","33",null,null,null,null,null,null,this.Div00.form.Div01.form.Div00.form);
            obj.set_taborder("9");
            ...
            obj = new Static("Static100_00_01","0","Static100:99",null,"51","0",null,null,null,null,null,this.Div00.form.Div01.form.Div00.form);
            obj.set_taborder("13");
            obj.set_cssclass("portal_sta_memLabelBg");
            obj.set_text("");
            this.Div00.form.Div01.form.Div00.addChild(obj.name, obj);

            obj = new Static("Static02_00","0","150","200","51",null,null,null,null,null,null,this.Div00.form.Div01.form.Div00.form);
            obj.set_taborder("14");
            obj.set_text("조회수");
            obj.set_font("normal bold 16px/normal \"맑은고딕\"");
            obj.set_cssclass("portal_sta_memLabel_L");
            ...
            obj = new Edit("Edit02_00","Static02:10","159","160","33",null,null,null,null,null,null,this.Div00.form.Div01.form.Div00.form);
            obj.set_taborder("15");
            obj.set_cssclass("portal_edi");
            obj.set_text("krit005");
            this.Div00.form.Div01.form.Div00.addChild(obj.name, obj);

            obj = new CheckBox("chk_notice","Edit01:10","9","107","33",null,null,null,null,null,null,this.Div00.form.Div01.form.Div00.form);
            obj.set_taborder("16");
            obj.set_text("공지");
            obj.set_cssclass("portal_chk");
            this.Div00.form.Div01.form.Div00.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("PTS_3060M_03.xfdl", function() {
        ...
        this.loadIncludeScript("PTS_3060M_03.xfdl");
