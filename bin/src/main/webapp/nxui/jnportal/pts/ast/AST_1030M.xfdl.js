(function()
{
    return function()
    {
        ...
        {
            this.set_name("AST_1030M");
            this.set_titletext("자원신청목록");
            ...
            obj.set_updatecontrol("true");
            obj._setContents("<ColumnInfo><Column id=\"astNo\" type=\"STRING\" size=\"256\"/><Column id=\"astNm\" type=\"STRING\" size=\"256\"/><Column id=\"astQty\" type=\"STRING\" size=\"256\"/><Column id=\"rgstrId\" type=\"STRING\" size=\"256\"/><Column id=\"astRtnDueYmd\" type=\"STRING\" size=\"256\"/><Column id=\"astUseYmd\" type=\"STRING\" size=\"256\"/><Column id=\"rgstDt\" type=\"STRING\" size=\"256\"/><Column id=\"rgstrIdNm\" type=\"STRING\" size=\"256\"/><Column id=\"astMngPicIdNm\" type=\"STRING\" size=\"256\"/><Column id=\"astRqstUserId\" type=\"STRING\" size=\"256\"/><Column id=\"astRqstUserIdNm\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"48\" band=\"left\"/><Column size=\"58\" band=\"left\"/><Column size=\"121\"/><Column size=\"150\"/><Column size=\"195\"/><Column size=\"98\"/><Column size=\"85\"/><Column size=\"89\"/><Column size=\"82\"/><Column size=\"108\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"34\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"순번\"/><Cell col=\"2\" text=\"구분\"/><Cell col=\"3\" text=\"자원번호\"/><Cell col=\"4\" text=\"자원명\"/><Cell col=\"5\" text=\"신청자\"/><Cell col=\"6\" text=\"수량\"/><Cell col=\"7\" text=\"사용기간\"/><Cell col=\"8\" text=\"반납예정일자\"/><Cell col=\"9\" text=\"신청일자\"/></Band><Band id=\"body\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" textAlign=\"center\" text=\"bind:rowCheck\"/><Cell col=\"1\" expr=\"currow+1\" text=\"expr:currow+1\" textAlign=\"center\"/><Cell col=\"2\" displaytype=\"normal\" edittype=\"none\" text=\"bind:astDivCdNm\" combodataset=\"dsWorkKindListCbo\" combodatacol=\"text\" textAlign=\"center\" combocodecol=\"value\"/><Cell col=\"3\" text=\"bind:astNo\" textAlign=\"center\" editmaxlength=\"-1\" displaytype=\"normal\" edittype=\"none\" expandshow=\"hide\" expandsize=\"16\"/><Cell col=\"4\" text=\"bind:astNm\" editmaxlength=\"20\" textAlign=\"center\" displaytype=\"normal\"/><Cell col=\"5\" text=\"bind:astRqstUserIdNm\" edittype=\"none\" displaytype=\"normal\" combodataset=\"dsPowCbo\" combodatacol=\"text\" textAlign=\"center\" combocodecol=\"value\"/><Cell col=\"6\" text=\"bind:astQty\" edittype=\"none\" displaytype=\"normal\" combodataset=\"dsUseYn\" combocodecol=\"value\" combodatacol=\"text\" textAlign=\"left\"/><Cell col=\"7\" text=\"bind:astUseYmd\"/><Cell col=\"8\" text=\"bind:astRtnDueYmd\"/><Cell col=\"9\" text=\"bind:rgstDt\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd\"/></Band></Format></Formats>");
            ...
            obj = new Layout("default","",0,0,this.divDirectorResult.form,
                ...
                p.btnAddAst.set_text("자원신청");
                p.btnAddAst.set_cssclass("btn_WF_icoApplication");
        ...
        // User Script
        this.addIncludeScript("AST_1030M.xfdl","lib::common.xjs");
        this.registerScript("AST_1030M.xfdl", function() {
        /**
        *  사이트 관리
        *  MenuPath      자원  > 자원 목록
        ...
        */
        ...
        {
        	var strSvcId    = "getResourcesRqsList";
        ...
        */
        ...
        {
        	nexacro.getApplication().openNewTab("AST_1040M", "자원등록", "pts::ast/AST_1040M.xfdl", "" , "자원 > 자원목록 > 자원 신청", "");
        };
        ...
        */
        this.divResult_grdList_oncelldblclick = function(obj,e)
        {
        	...
        	nexacro.getApplication().openNewTab("FAQ_2020M", "자원등록 상세", "pts::ast/AST_1020M.xfdl", param , "자원 > 자원목록 > 자원 상세 페이지", "");
        };
        ...
        ************************************************************************************************/
        ...
        this.loadIncludeScript("AST_1030M.xfdl");
