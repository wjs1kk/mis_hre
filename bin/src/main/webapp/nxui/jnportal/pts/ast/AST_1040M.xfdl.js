(function()
{
    return function()
    {
        ...
        {
            this.set_name("AST_1040M");
            this.set_titletext("자원신청");
            ...
            obj = new Button("btnExit","btnDelete:5","10","65","28",null,null,null,null,null,null,this.divResisterForm.form);
            obj.set_text("닫기");
            ...
            obj = new Button("btnDeptMngr00_00_00","edtTitle:5","48","26","26",null,null,null,null,null,null,this.divResisterForm.form);
            obj.set_taborder("40");
            obj.set_cssclass("btn_WF_frmSearch");
            obj.set_text("");
            this.divResisterForm.addChild(obj.name, obj);

            obj = new Static("starqstrDt00","455","44","150","34",null,null,null,null,null,null,this.divResisterForm.form);
            obj.set_taborder("22");
            obj.set_text("자원명");
            obj.set_cssclass("sta_WF_condition02");
            this.divResisterForm.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"48\" band=\"left\"/><Column size=\"58\" band=\"left\"/><Column size=\"100\"/><Column size=\"190\"/><Column size=\"150\"/><Column size=\"195\"/><Column size=\"98\"/><Column size=\"85\"/><Column size=\"89\"/><Column size=\"89\"/><Column size=\"101\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"34\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"순번\"/><Cell col=\"2\" text=\"구분\"/><Cell col=\"3\" text=\"자원 고유번호\"/><Cell col=\"4\" text=\"취득일\"/><Cell col=\"5\" text=\"사용부서\"/><Cell col=\"6\" text=\"사용자\"/><Cell col=\"7\" text=\"상태\"/><Cell col=\"8\" text=\"사용시작일\"/><Cell col=\"9\" text=\"반납예정일\"/><Cell col=\"10\" text=\"사용여부\"/></Band><Band id=\"body\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" textAlign=\"center\" text=\"bind:rowCheck\"/><Cell col=\"1\" expr=\"currow+1\" text=\"expr:currow+1\" textAlign=\"center\"/><Cell col=\"2\" text=\"bind:astDivCd\"/><Cell col=\"3\" displaytype=\"normal\" edittype=\"none\" text=\"bind:astSrlNo\" combodatacol=\"text\" textAlign=\"center\" combocodecol=\"value\"/><Cell col=\"4\" text=\"bind:astAqstnYmd\" textAlign=\"center\" editmaxlength=\"-1\" displaytype=\"normal\" edittype=\"none\" expandshow=\"hide\" expandsize=\"16\"/><Cell col=\"5\" text=\"bind:astUseDeptCdNm\" editmaxlength=\"20\" textAlign=\"center\" displaytype=\"normal\"/><Cell col=\"6\" text=\"bind:astUseUserIdNm\" edittype=\"none\" displaytype=\"normal\" combodataset=\"dsPowCbo\" combodatacol=\"text\" textAlign=\"center\" combocodecol=\"value\"/><Cell col=\"7\" text=\"bind:astSttsCdNm\" edittype=\"none\" displaytype=\"normal\" combodataset=\"dsUseYn\" combocodecol=\"value\" combodatacol=\"text\" textAlign=\"left\"/><Cell col=\"8\" displaytype=\"date\" edittype=\"date\" text=\"bind:astUseBgnYmd\" calendardateformat=\"yyyy-MM-dd\"/><Cell col=\"9\" text=\"bind:astRtnDueYmd\" displaytype=\"date\" edittype=\"date\" calendardateformat=\"yyyy-MM-dd\"/><Cell col=\"10\" text=\"bind:useYn\" displaytype=\"normal\" edittype=\"none\" combodataset=\"dsUseYn\" combocodecol=\"value\" combodatacol=\"text\"/></Band></Format></Formats>");
            this.divResisterForm.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.addIncludeScript("AST_1040M.xfdl","lib::common.xjs");
        this.registerScript("AST_1040M.xfdl", function() {
        /**
        *  처리 등록
        ...
        ************************************************************************************************/
         ...
         * description 자원신청
         */
        this.fnAstRqst = function()
        {
        	this.gfnTransaction("getAstRqstApply", "ast/resources/getAstRqstApply.do", "dsDetailList", "", "", "fnCallback");
        };
        ...
        */
        this.divResisterForm_btnDeptMngr_onclick = function(obj,e)
        {
        	...
        	this.gfnOpenPopup("astNoSearch", "pts::ast/AST_1040P.xfdl", args, "fnCallback", "");
        };
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.divResisterForm.form.btnExit.addEventHandler("onclick",this.divResisterForm_btnModify_onclick,this);
        ...
        this.loadIncludeScript("AST_1040M.xfdl");
