(function()
{
    return function()
    {
        ...
        {
            this.set_name("PTS_6000M_01");
            this.set_titletext("외부 마이페이지");
            ...
            obj = new Static("Static00","0","Div02:20",null,"568","0",null,null,null,null,null,this);
            obj.set_taborder("7");
            ...
            obj = new Button("Button01","74","65","125","36",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("3");
            obj.set_text("회원정보");
            ...
            obj = new Button("Button01_00","Button01:-1","65","125","36",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("4");
            obj.set_text("관심게시물");
            obj.set_cssclass("portal_btn_charge");
        ...
        // User Script
        this.registerScript("PTS_6000M_01.xfdl", function() {
        ...
        this.loadIncludeScript("PTS_6000M_01.xfdl");
