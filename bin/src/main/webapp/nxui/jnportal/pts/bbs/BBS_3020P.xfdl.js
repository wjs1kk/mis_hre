(function()
{
    return function()
    {
        ...
        {
            this.set_name("BBS_3020P");
            this.set_titletext("비밀글-비밀번호 확인");
            ...
            obj.set_taborder("1");
            obj.set_text("비밀글 입니다. 비밀번호를 입력하세요.");
        ...
        // User Script
        this.addIncludeScript("BBS_3020P.xfdl","lib::common.xjs");
        this.registerScript("BBS_3020P.xfdl", function() {
         /**
        *  비밀번호 확인 PopUp
        ...
        */
        ...
        this.loadIncludeScript("BBS_3020P.xfdl");
