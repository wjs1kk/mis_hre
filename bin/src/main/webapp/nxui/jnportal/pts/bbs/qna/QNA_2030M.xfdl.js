(function()
{
    return function()
    {
        ...
        {
            this.set_name("QNA_2030M");
            this.set_titletext("QNA 목록");
            ...
            obj._setContents("<ColumnInfo><Column id=\"searchType\" type=\"STRING\" size=\"256\"/><Column id=\"searchKeyword\" type=\"STRING\" size=\"256\"/><Column id=\"qnaId\" type=\"STRING\" size=\"256\"/><Column id=\"clsCd\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\" band=\"left\"/><Column size=\"150\"/><Column size=\"750\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"34\"/></Rows><Band id=\"head\"><Cell displaytype=\"normal\" edittype=\"none\" text=\"순번\"/><Cell col=\"1\" text=\"분류\"/><Cell col=\"2\" text=\"제목\"/><Cell col=\"3\" text=\"조회수\"/><Cell col=\"4\" text=\"등록일\"/><Cell col=\"5\" text=\"최종수정일\"/><Cell col=\"6\" text=\"작성자\"/></Band><Band id=\"body\"><Cell displaytype=\"normal\" edittype=\"none\" textAlign=\"center\" text=\"expr:currow+1\" expr=\"currow+1\"/><Cell col=\"1\" text=\"bind:clsNm\"/><Cell col=\"2\" text=\"bind:qstnTtl\" editmaxlength=\"20\" textAlign=\"left\" displaytype=\"normal\" edittype=\"none\"/><Cell col=\"3\" text=\"bind:rdcnt\"/><Cell col=\"4\" text=\"bind:rgstDt\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd\"/><Cell col=\"5\" text=\"bind:updtDt\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd\"/><Cell col=\"6\" text=\"bind:rgstrMemberId\"/></Band></Format></Formats>");
        ...
        // User Script
        this.addIncludeScript("QNA_2030M.xfdl","lib::common.xjs");
        this.registerScript("QNA_2030M.xfdl", function() {
        /**
        *  QNA 목록
        ...
        ************************************************************************************************/
        ...
        this.loadIncludeScript("QNA_2030M.xfdl");
