(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_treeinitstatus("expand,null");
            obj.set_cssclass("grd_WF_tree");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\" band=\"left\"/><Column size=\"40\" band=\"left\"/><Column size=\"40\" band=\"left\"/><Column size=\"200\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"34\"/></Rows><Band id=\"head\"><Cell text=\"순번\"/><Cell col=\"1\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"2\" text=\"상태\"/><Cell col=\"3\" text=\"조직\"/></Band><Band id=\"body\"><Cell expr=\"currow+1\" text=\"expr:currow+1\" textAlign=\"center\"/><Cell col=\"1\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\" textAlign=\"center\" text=\"bind:rowCheck\"/><Cell col=\"2\" textAlign=\"center\" imagestretch=\"fit\" displaytype=\"normal\" text=\"bind:rowStatus\"/><Cell col=\"3\" text=\"bind:orgnNm\" edittype=\"tree\" treelevel=\"bind:level\" textAlign=\"left\" displaytype=\"treeitemcontrol\" treecheck=\"bind:rowCheck\"/></Band></Format></Formats>");
        ...
        */
        this.divDeptResult_btnAddDept_onclick = function(obj,e)
        {
        	...
        	this.gfnOpenPopup("ORGN_1000P", "org::ptsOrgnInfo/ORGN_1000P.xfdl", oArg, "fnPopupAfter", "");
        };
