(function()
{
    return function()
    {
        ...
        this.fnCallback = function (svcId, errorCode, errorMsg)
        {
            switch (svcId) {
                case "findId":
                    this.gfnOpenPopup("findIdResult", "mif::login/MIF_3020P_01.xfdl", { memberId: this.foundMemberId }, "fnPopupCallback");
                    break;
                case "findPassword":
                    this.gfnOpenPopup("findIdResult", "mif::login/MIF_3020P_02.xfdl", { emlAddr: this.emlAddr }, "fnPopupCallback");
                    break;
                default:
                    break;
            }
