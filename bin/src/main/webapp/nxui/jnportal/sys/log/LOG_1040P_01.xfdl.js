(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divLogDitail","30","70","740",null,null,"76",null,null,null,null,this.divPopup.form);
            obj.set_taborder("4");
            obj.set_cssclass("div_WF_popup");
            obj.set_text("");
            this.divPopup.addChild(obj.name, obj);

            obj = new Static("Static10","0","0","20",null,null,"0",null,null,null,null,this.divPopup.form.divLogDitail.form);
            obj.set_taborder("0");
            obj.set_text("w20");
            obj.set_visible("false");
            obj.set_background("fuchsia");
            ...
            obj.set_opacity("0.7");
            obj.set_font("normal 12px/normal \"Arial\"");
            this.divPopup.form.divLogDitail.addChild(obj.name, obj);

            obj = new Static("Static04_00_00_00","110","0","60","45",null,null,null,null,null,null,this.divPopup.form.divLogDitail.form);
            obj.set_taborder("1");
            obj.set_text("h 45");
            obj.set_visible("false");
            obj.set_background("aqua");
            ...
            obj = new Static("staSubTitle","20","0","169","45",null,null,null,null,null,null,this.divPopup.form.divLogDitail.form);
            obj.set_taborder("2");
            obj.set_text("상세 정보");
            obj.set_cssclass("sta_WF_subTitle01");
            this.divPopup.form.divLogDitail.addChild(obj.name, obj);

            obj = new Static("Static10_00_00_01_00",null,"0","20",null,"0","0",null,null,null,null,this.divPopup.form.divLogDitail.form);
            obj.set_taborder("3");
            obj.set_text("w20");
            obj.set_visible("false");
            obj.set_background("fuchsia");
            ...
            obj = new TextArea("taLogDetail","20","45",null,null,"20","20",null,null,null,null,this.divPopup.form.divLogDitail.form);
            obj.set_taborder("4");
            ...
            obj = new Button("btnPopupClose",null,null,"65","28","367","23",null,null,null,null,this.divPopup.form);
            obj.set_text("닫기");
            obj.set_cssclass("");
            ...
            this.divPopup.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this.divPopup.form.divLogDitail.form
            obj = new Layout("default","",1032,72,this.divPopup.form.divLogDitail.form,function(p){});
            this.divPopup.form.divLogDitail.form.addLayout(obj.name, obj);
            ...
            obj = new BindItem("item0","divPopup.form.divLogDitail.form.taLogDetail","value","dsLogDtail","logCont");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("LOG_1040P_01.xfdl","lib::common.xjs");
        this.registerScript("LOG_1040P_01.xfdl", function() {
        /**
        *  Popup Template
        *  MenuPath      -
        ...
        ************************************************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.divPopup.form.divLogDitail.form.Static04_00_00_00.addEventHandler("onclick",this.Static31_onclick,this);
            this.divPopup.form.divLogDitail.form.staSubTitle.addEventHandler("onclick",this.Static09_onclick,this);
            this.divPopup.form.divLogDitail.form.Static10_00_00_01_00.addEventHandler("onclick",this.div_Search_Static10_00_onclick,this);
        ...
        this.loadIncludeScript("LOG_1040P_01.xfdl");
