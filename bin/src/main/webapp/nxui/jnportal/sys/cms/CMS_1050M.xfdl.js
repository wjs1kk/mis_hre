(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("sta001","50","10","500","30",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Static("sta002","50","53","169","27",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("검색조건");
            ...
            obj = new Div("div_Search01","50","177",null,"483","50",null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_cssclass("");
            obj.set_text("");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta003","20","11","169","27",null,null,null,null,null,null,this.div_Search01.form);
            obj.set_taborder("5");
            obj.set_text("검색결과");
            obj.set_cssclass("sta_WF_subTitle01");
            this.div_Search01.addChild(obj.name, obj);
            ...
            obj = new Static("staGridRowCnt","109","12","149","27",null,null,null,null,null,null,this.div_Search01.form);
            obj.set_taborder("6");
            obj.set_text("(총 0건)");
            ...
            obj = new Static("sta004","11","9","110","34",null,null,null,null,null,null,this.divSearch.form.Div00.form);
            obj.set_taborder("0");
            obj.set_text("유형");
            obj.set_cssclass("sta_WF_condition01");
            this.divSearch.form.Div00.addChild(obj.name, obj);

            obj = new Static("sta005","305","9","110","34",null,null,null,null,null,null,this.divSearch.form.Div00.form);
            obj.set_taborder("1");
            obj.set_text("제목");
            obj.set_cssclass("sta_WF_condition01");
            this.divSearch.form.Div00.addChild(obj.name, obj);

            obj = new Edit("edtAdvtTitle","414","13","8.43%","26",null,null,null,null,null,null,this.divSearch.form.Div00.form);
            obj.set_taborder("2");
            this.divSearch.form.Div00.addChild(obj.name, obj);

            obj = new Static("sta006","621","9","110","34",null,null,null,null,null,null,this.divSearch.form.Div00.form);
            obj.set_taborder("3");
            obj.set_text("내용");
            obj.set_cssclass("sta_WF_condition01");
            this.divSearch.form.Div00.addChild(obj.name, obj);

            obj = new Edit("edtAdvtCont","730","13","8.43%","26",null,null,null,null,null,null,this.divSearch.form.Div00.form);
            obj.set_taborder("4");
            this.divSearch.form.Div00.addChild(obj.name, obj);

            obj = new Combo("cboAdTy","163","110","115","26",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            ...
            obj = new Layout("default","Desktop_screen",1920,670,this,
                ...
                p.sta001.set_text("배너 및 팝업 관리");
                p.sta001.set_cssclass("sta_WF_compTitle01");
                p.sta001.move("50","10","500","30",null,null);
                ...
                p.sta002.set_text("검색조건");
                p.sta002.set_cssclass("sta_WF_subTitle01");
                p.sta002.move("50","53","169","27",null,null);
                ...
                p.div_Search01.move("50","177",null,"483","50",null);
                ...
                p.cboAdTy.set_taborder("9");
                p.cboAdTy.set_datacolumn("text");
                p.cboAdTy.set_codecolumn("value");
                p.cboAdTy.set_innerdataset("dsAdTy");
                p.cboAdTy.set_text("");
                p.cboAdTy.set_value("");
                p.cboAdTy.set_index("-1");
                p.cboAdTy.move("163","110","115","26",null,null);
            	}
            );
            obj.set_stepcount("0");
            ...
            obj = new BindItem("item1","divSearch.form.Div00.form.edtAdvtTitle","value","dsSearch","advtTitle");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","divSearch.form.Div00.form.edtAdvtCont","value","dsSearch","advtCont");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","cboAdTy","value","dsSearch","advtType");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("CMS_1050M.xfdl","lib::common.xjs");
        this.registerScript("CMS_1050M.xfdl", function() {
        /**
        *  배너 및 팝업 관리
        ...
        */
        this.divSearch_Div00_onkeyup = function(obj,e)
        {
        	if(e.keycode==13){
        ...
        this.on_initEvent = function()
        {
            ...
            this.sta002.addEventHandler("onclick",this.div_Search_Static05_onclick,this);
            ...
            this.div_Search01.form.sta003.addEventHandler("onclick",this.Static09_onclick,this);
            ...
            this.divSearch.form.Div00.addEventHandler("onkeyup",this.divSearch_Div00_onkeyup,this);
            this.divSearch.form.Div00.form.sta004.addEventHandler("onclick",this.div_Search_Static01_onclick,this);
            this.divSearch.form.Div00.form.edtAdvtTitle.addEventHandler("onkeyup",this.divSearch_Div00_onkeyup,this);
            this.divSearch.form.Div00.form.edtAdvtCont.addEventHandler("onkeyup",this.divSearch_Div00_onkeyup,this);
            this.cboAdTy.addEventHandler("onkeyup",this.divSearch_Div00_onkeyup,this);
        };
        this.loadIncludeScript("CMS_1050M.xfdl");
