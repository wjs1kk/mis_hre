(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divPop","0","0","1000","460",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divInfo","30","70","940","313",null,null,null,null,null,null,this.divPop.form);
            obj.set_taborder("5");
            obj.set_cssclass("div_WF_popup");
            obj.set_text("");
            this.divPop.addChild(obj.name, obj);

            obj = new Static("Static10","0","-1","19","132",null,null,null,null,null,null,this.divPop.form.divInfo.form);
            obj.set_taborder("0");
            obj.set_text("w20");
            obj.set_visible("false");
            obj.set_background("fuchsia");
            ...
            obj.set_opacity("0.7");
            obj.set_font("normal 12px/normal \"Arial\"");
            this.divPop.form.divInfo.addChild(obj.name, obj);

            obj = new Static("Static04_00_00_00","110","0","60","45",null,null,null,null,null,null,this.divPop.form.divInfo.form);
            obj.set_taborder("1");
            obj.set_text("h 45");
            obj.set_visible("false");
            obj.set_background("aqua");
            ...
            obj = new Static("staTitle","19","11","169","27",null,null,null,null,null,null,this.divPop.form.divInfo.form);
            obj.set_taborder("2");
            obj.set_text("주요사항");
            obj.set_cssclass("sta_WF_subTitle01");
            this.divPop.form.divInfo.addChild(obj.name, obj);

            obj = new ListView("lvProjectInfo","19","45",null,null,"20","23",null,null,null,null,this.divPop.form.divInfo.form);
            obj.set_taborder("3");
            ...
            this.divPop.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this.divPop.form.divInfo.form
            obj = new Layout("default","",1032,72,this.divPop.form.divInfo.form,function(p){});
            this.divPop.form.divInfo.form.addLayout(obj.name, obj);
            ...
            obj = new BindItem("item54","divPop.form.divInfo.form.SCH_RQST_NO","value","ds_search","SCH_RQST_NO");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item55","divPop.form.divInfo.form.SCH_RQST_DT","value","ds_search","SCH_RQST_DT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item56","divPop.form.divInfo.form.SCH_RQST_ID","value","ds_search","SCH_RQST_ID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item57","divPop.form.divInfo.form.SCH_APV_STAT_CD","value","ds_search","SCH_APV_STAT_CD");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item58","divPop.form.divInfo.form.SCH_LAST_UPT_NM","value","ds_search","SCH_LAST_UPT_NM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item59","divPop.form.divInfo.form.SCH_LAST_UPT_DT","value","ds_search","SCH_LAST_UPT_DT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item60","divPop.form.divInfo.form.SCH_DEPT_CD","value","ds_search","SCH_RQST_DEPT_NM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item61","divPop.form.divInfo.form.SCH_RQST_NM","value","ds_search","SCH_RQST_NM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item62","divPop.form.divInfo.form.SCH_CAL_MON","value","ds_search","SCH_CAL_MON");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item63","divPop.form.divInfo.form.Radio00","value","ds_main","INOUT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item64","divPop.form.divInfo.form.CheckBox00","value","ds_main","COM_CAR_YN");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item65","divPop.form.divInfo.form.Spin00","value","ds_main","YY");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item66","divPop.form.divInfo.form.Combo00","value","ds_main","TP");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item67","divPop.form.divInfo.form.Edit05","value","ds_main","RQST_AMT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item68","divPop.form.divInfo.form.RQST_NM","value","ds_main","RQST_ID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item69","divPop.form.divInfo.form.TextArea01","value","ds_main","CONT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item70","divPop.form.divInfo.form.SBJ","value","ds_main","SBJ");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item71","divPop.form.divInfo.form.FRM_DT","value","ds_main","FRM_DT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item72","divPop.form.divInfo.form.TO_DT","value","ds_main","TO_DT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item73","divPop.form.divInfo.form.rqstNo","value","ds_main","RQST_NO");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item74","divPop.form.divInfo.form.commCd","value","ds_main","COMM_CD");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item75","divPop.form.divInfo.form.SCH_RQST_DT00","value","ds_search","SCH_RQST_DT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item76","divPop.form.divInfo.form.SCH_RQST_DT00_00","value","ds_search","SCH_RQST_DT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item77","divPop.form.divInfo.form.SCH_RQST_DT00_00_00","value","ds_search","SCH_RQST_DT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item78","divPop.form.divInfo.form.SCH_RQST_DT00_00_01","value","ds_search","SCH_RQST_DT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item79","divPop.form.divInfo.form.SCH_RQST_DT00_00_00_00","value","ds_search","SCH_RQST_DT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item80","divPop.form.divInfo.form.RQST_NM00","value","ds_main","RQST_ID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item81","divPop.form.divInfo.form.RQST_NM00_00","value","ds_main","RQST_ID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item82","divPop.form.divInfo.form.RQST_NM00_00_00","value","ds_main","RQST_ID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item83","divPop.form.divInfo.form.RQST_NM00_00_01","value","ds_main","RQST_ID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item84","divPop.form.divInfo.form.RQST_NM00_00_01_00","value","ds_main","RQST_ID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item85","divPop.form.divInfo.form.RQST_NM00_00_00_00","value","ds_main","RQST_ID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item86","divPop.form.divInfo.form.RQST_NM00_00_01_00_00","value","ds_main","RQST_ID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item87","divPop.form.divInfo.form.RQST_NM00_00_01_00_01","value","ds_main","RQST_ID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item88","divPop.form.divInfo.form.RQST_NM00_00_00_00_00","value","ds_main","RQST_ID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item89","divPop.form.divInfo.form.RQST_NM00_00_01_00_00_00","value","ds_main","RQST_ID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item90","divPop.form.divInfo.form.RQST_NM00_00_02","value","ds_main","RQST_ID");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("CMS_1030P_02.xfdl","lib::common.xjs");
        this.registerScript("CMS_1030P_02.xfdl", function() {
        /**
        *  Popup Template
        *  MenuPath      -
        ...
        */
        ...
        this.divPop_divInfo_lvProjectInfo_oncellclick = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.divPop.form.divInfo.form.Static04_00_00_00.addEventHandler("onclick",this.Static31_onclick,this);
            this.divPop.form.divInfo.form.staTitle.addEventHandler("onclick",this.Static09_onclick,this);
            this.divPop.form.divInfo.form.lvProjectInfo.addEventHandler("oncellclick",this.divPop_divInfo_lvProjectInfo_oncellclick,this);
        ...
        this.loadIncludeScript("CMS_1030P_02.xfdl");
