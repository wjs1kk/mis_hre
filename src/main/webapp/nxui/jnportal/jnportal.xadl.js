(function()
{
    return function()  
	{
        ...
        this.mainframe_createBodyFrame = function()
        {
            ...
            frame0.set_separatesize("111,35,*,100");
            ...
            var frame2 = new ChildFrame("TabBarFrame",null,null,null,null,null,null,"FrameBase::Form_TabBar.xfdl",frame0);
            frame2.set_showtitleicon("false");
            frame2.set_showtitlebar("false");
            frame2.set_dragmovetype("none");
            frame0.addChild(frame2.name, frame2);
            frame2.set_formurl("FrameBase::Form_TabBar.xfdl");


            var frame3 = new FrameSet("MainFrameSet",null,null,null,null,null,null,frame0);
            frame3.set_border("0px none");
            frame0.addChild(frame3.name, frame3);

            var frame4 = new ChildFrame("FooterFrame",null,null,null,null,null,null,"FrameBase::Form_Footer.xfdl",frame0);
            frame4.set_showtitlebar("false");
            frame4.set_showtitleicon("false");
            frame4.set_dragmovetype("none");
            frame0.addChild(frame4.name, frame4);
            frame4.set_formurl("FrameBase::Form_Footer.xfdl");
        };
