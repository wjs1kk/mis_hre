if (nexacro.Environment)
{
    ...
    env.loadTypeDefinition = function ()
    {
        ...
        nexacro._addService("svcQuickCodeTutorial", "model", "./svcQuickCodeTutorial/", "none", null, "", "0", "0");
        ...
        var registerclass = [
        		...
        		{"id":"TutorialAlertAction", "classname":"nexacro.TutorialAlertAction", "type":"JavaScript"},
        		{"id":"TutorialQueryAction", "classname":"nexacro.TutorialQueryAction", "type":"JavaScript"},
    ...
    env.on_loadVariables = function ()
    {
        ...
        nexacro.setEnvironmentVariable("gvLang", "ko");
        // Cookies

        // HTTP Header
        nexacro.setHTTPHeaderVariable("WhoAreYou", "Nexacro");
    };
