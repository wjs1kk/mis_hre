(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("ROLE_1030P.xfdl","lib::common.xjs");
        this.registerScript("ROLE_1030P.xfdl", function() {
        /**
         *  Popup Template
         *  MenuPath      -
        ...
        */
        ...
        this.loadIncludeScript("ROLE_1030P.xfdl");
