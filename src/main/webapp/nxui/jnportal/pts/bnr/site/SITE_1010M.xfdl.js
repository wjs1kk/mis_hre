(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"48\" band=\"left\"/><Column size=\"48\" band=\"left\"/><Column size=\"48\" band=\"left\"/><Column size=\"201\"/><Column size=\"343\"/><Column size=\"107\"/><Column size=\"126\"/><Column size=\"96\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"34\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"순번\"/><Cell col=\"2\" text=\"상태\"/><Cell col=\"3\" text=\"사이트명\"/><Cell col=\"4\" text=\"사이트URL\"/><Cell col=\"5\" text=\"등록자\"/><Cell col=\"6\" text=\"등록일\"/><Cell col=\"7\" text=\"사용여부\"/></Band><Band id=\"body\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" textAlign=\"center\" text=\"bind:rowCheck\"/><Cell col=\"1\" expr=\"currow+1\" text=\"expr:currow+1\" textAlign=\"center\"/><Cell col=\"2\" text=\"bind:rowStatus\"/><Cell col=\"3\" text=\"bind:siteNm\" textAlign=\"left\" editmaxlength=\"50\" displaytype=\"editcontrol\" edittype=\"text\"/><Cell col=\"4\" text=\"bind:siteUrl\" editmaxlength=\"200\" textAlign=\"left\" displaytype=\"editcontrol\" edittype=\"text\" editinputtype=\"english,dot,symbol\"/><Cell col=\"5\" text=\"bind:rgstrId\"/><Cell col=\"6\" textAlign=\"center\" editmaxlength=\"3000\" displaytype=\"normal\" text=\"bind:updtDt\"/><Cell col=\"7\" text=\"bind:useYn\" edittype=\"combo\" displaytype=\"combocontrol\" combodataset=\"dsUseYn\" combocodecol=\"value\" combodatacol=\"text\"/></Band></Format></Formats>");
            ...
            obj = new Layout("default","",0,0,this.divSiteResult.form,
                ...
                p.grdSiteList.set_autoenter("none");
        ...
        ************************************************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.cboSearchId.addEventHandler("onitemchanged",this.divSearch_edtSearchNm_onchanged,this);
