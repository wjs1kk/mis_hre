(function()
{
    return function()
    {
        ...
        {
            this.set_name("MAL_1050M");
            this.set_titletext("메일 템플릿 목록");
            ...
            divSearch_form_cboSearch_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"datacolumn\">템플릿 명</Col></Row><Row><Col id=\"datacolumn\">템플릿 ID</Col><Col id=\"codecolumn\">emlTmpltId</Col></Row></Rows>");
            ...
            obj = new Button("btnTmpltAdd",null,null,"100","28","0","grdList:5",null,null,null,null,this.divResult.form);
            obj.set_taborder("2");
            obj.set_text("템플릿 추가");
            ...
            obj = new Layout("default","",0,0,this.divResult.form,
                ...
                p.btnTmpltAdd.set_taborder("2");
                p.btnTmpltAdd.set_text("템플릿 추가");
                p.btnTmpltAdd.set_cssclass("btn_WF_icoAdd");
                p.btnTmpltAdd.move(null,null,"100","28","0","grdList:5");
            	}
            );
            ...
            obj = new BindItem("item2","divSearch.form.calStrYmd","value","dsSearch","sndStrDtF");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","divSearch.form.calEndYmd","value","dsSearch","sndStrDtT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("MAL_1050M.xfdl","lib::common.xjs");
        this.registerScript("MAL_1050M.xfdl", function() {
        /**
        *  메일템플릿 목록
        ...
        */
        ...
        this.divResult_btnTmpltAdd_onclick = function(obj,e)
        {
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.divResult.form.btnTmpltAdd.addEventHandler("onclick",this.divResult_btnTmpltAdd_onclick,this);
        };
        this.loadIncludeScript("MAL_1050M.xfdl");
