(function()
{
    return function()
    {
        ...
        {
            this.set_name("PTS_6020U_02");
            this.set_titletext("관심 게시물");
            ...
            obj._setContents("<ColumnInfo><Column id=\"col1\" type=\"STRING\" size=\"256\"/><Column id=\"col2\" type=\"STRING\" size=\"256\"/><Column id=\"col3\" type=\"STRING\" size=\"256\"/><Column id=\"col4\" type=\"STRING\" size=\"256\"/><Column id=\"col5\" type=\"STRING\" size=\"256\"/><Column id=\"col6\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"col2\">잠수함용 신형 소자장비 설계 기술(시험개발)</Col><Col id=\"col3\">접수중</Col><Col id=\"col4\">2023.03.30~2023.04.30</Col><Col id=\"col5\">상세보기</Col><Col id=\"col1\">10</Col><Col id=\"col6\">핵심기슬</Col></Row><Row><Col id=\"col1\">9</Col><Col id=\"col2\">잠수함 첨단함형 특화연구실</Col><Col id=\"col3\">접수중</Col><Col id=\"col4\">2023.03.30~2023.05.11</Col><Col id=\"col5\">상세보기</Col><Col id=\"col6\">핵심기슬</Col></Row><Row><Col id=\"col1\">8</Col><Col id=\"col2\">미래 기술 적응형 통합수중감시 특화연구센터</Col><Col id=\"col3\">접수중</Col><Col id=\"col4\">2023.02.30~2023.05.15</Col><Col id=\"col5\">상세보기</Col><Col id=\"col6\">방산진흥</Col></Row><Row><Col id=\"col1\">7</Col><Col id=\"col2\">소형 고속 수중운동체를 위한 소형 고출력 AFPM 전동…</Col><Col id=\"col3\">접수중</Col><Col id=\"col4\">2023.03.30~2023.05.17</Col><Col id=\"col5\">상세보기</Col><Col id=\"col6\">방산진흥</Col></Row><Row><Col id=\"col1\">6</Col><Col id=\"col2\">센서 대역별 환경모델 특화연구실 (기초연구)</Col><Col id=\"col3\">접수대기</Col><Col id=\"col4\">2023.03.30~2023.05.17</Col><Col id=\"col5\">상세보기</Col><Col id=\"col6\">핵심기슬</Col></Row><Row><Col id=\"col1\">5</Col><Col id=\"col2\">포발사형 유도무기용 정밀 MEMS 항법기술(시험개발)</Col><Col id=\"col3\">접수중</Col><Col id=\"col4\">2023.03.30~2023.05.17</Col><Col id=\"col5\">상세보기</Col><Col id=\"col6\">핵심기슬</Col></Row><Row><Col id=\"col1\">4</Col><Col id=\"col2\">잠수함 연동 어뢰기만기체계 설계기술 개발(응용연구)</Col><Col id=\"col3\">마감</Col><Col id=\"col4\">2023.03.30~2023.05.09</Col><Col id=\"col5\">결과확인</Col><Col id=\"col6\">방산진흥</Col></Row><Row><Col id=\"col1\">3</Col><Col id=\"col2\">국방 양자 컴퓨팅 &amp; 센싱 기술 특화연구센터(기초연구)</Col><Col id=\"col3\">접수중</Col><Col id=\"col4\">2023.03.30~2023.05.09</Col><Col id=\"col5\">상세보기</Col><Col id=\"col6\">핵심기슬</Col></Row><Row><Col id=\"col1\">2</Col><Col id=\"col2\">Heli-borne MUMT 개발 기술(무기체계 패키지형)</Col><Col id=\"col3\">접수중</Col><Col id=\"col4\">2023.03.30~2023.05.16</Col><Col id=\"col5\">상세보기</Col><Col id=\"col6\">핵심기슬</Col></Row><Row><Col id=\"col1\">1</Col><Col id=\"col2\">잠수함용 신형 소자장비 설계 기술(시험개발)</Col><Col id=\"col3\">접수중</Col><Col id=\"col4\">2023.03.30~2023.05.11</Col><Col id=\"col5\">상세보기</Col><Col id=\"col6\">방산진흥</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("Div00","180","0",null,"923","180",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("Div00");
            this.addChild(obj.name, obj);

            obj = new Static("Static10","559","43","156","50",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("4");
            obj.set_text("북마크 게시물");
            obj.set_enable("true");
            obj.set_cssclass("portal_sta_bdCategory");
            this.Div00.addChild(obj.name, obj);

            obj = new Static("Static01","0","Static10:-3","62","88",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("0");
            obj.set_text("전체 <fc v=\'#213878\'>32</fc>건");
            obj.set_enable("true");
            ...
            obj = new Button("btnSearch",null,"122","60","38","0",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("1");
            obj.set_cssclass("portal_btn");
            obj.set_text("검색");
            this.Div00.addChild(obj.name, obj);

            obj = new Edit("Edit07",null,"122","150","38","btnSearch:10",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("2");
            obj.set_displaynulltext("검색어 입력");
            obj.set_cssclass("portal_edi_search");
            this.Div00.addChild(obj.name, obj);

            obj = new Static("Static12","874","43","127","50",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("6");
            obj.set_text("나의 Q&A");
            obj.set_enable("true");
            obj.set_cssclass("portal_sta_bdCategory");
            ...
            obj = new Combo("Combo00",null,"Static12:29","100","38","Edit07:10",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("3");
            ...
            obj = new Static("Static11","725","43","139","50",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("5");
            obj.set_text("관심 게시물");
            obj.set_enable("true");
            ...
            obj = new Grid("Grid01_00","0","Static01:0",null,null,"0","65",null,null,null,null,this.Div00.form);
            obj.set_taborder("7");
            obj.set_binddataset("dsList");
            obj.set_tooltiptype("default");
            obj.set_autofittype("col");
            obj.set_cssclass("portal_grd_bdList");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"70\"/><Column size=\"180\"/><Column size=\"850\"/><Column size=\"120\"/><Column size=\"220\"/><Column size=\"120\"/></Columns><Rows><Row size=\"67\" band=\"head\"/><Row size=\"61\"/></Rows><Band id=\"head\"><Cell text=\"NO\"/><Cell col=\"1\" text=\"구분\"/><Cell col=\"2\" text=\"공고명\"/><Cell col=\"3\" text=\"진행상태\"/><Cell col=\"4\" text=\"기간\"/><Cell col=\"5\" text=\"상세\"/></Band><Band id=\"body\"><Cell text=\"bind:col1\"/><Cell col=\"1\" text=\"bind:col6\"/><Cell col=\"2\" displaytype=\"text\" edittype=\"none\" text=\"bind:col2\" calendardateformat=\"yyyy-MM-dd\" textAlign=\"left\"/><Cell col=\"3\" displaytype=\"normal\" edittype=\"none\" text=\"bind:col3\" cssclass=\"expr:dataset.parent.fnGridStates(col3)\"/><Cell col=\"4\" displaytype=\"normal\" edittype=\"normal\" text=\"bind:col4\" calendardateformat=\"yyyy-MM-dd\"/><Cell col=\"5\" cssclass=\"grd_detail\" displaytype=\"buttoncontrol\" edittype=\"button\" text=\"bind:col5\" controlautosizingtype=\"none\"/></Band></Format></Formats>");
            this.Div00.addChild(obj.name, obj);

            obj = new Button("btnSearch00",null,"122","138","38","Combo00:10",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("8");
            obj.set_cssclass("portal_btn2");
        ...
        // User Script
        this.registerScript("PTS_6020U_02.xfdl", function() {
        ...
        */
        ...
        {
        	var objChild = new ChildFrame("PTS_6020U_02P", "absolute", 0, 0, 810, 360);
        	objChild.set_formurl("pts::PTS_6020U_02P.xfdl");
        	objChild.set_openalign("center middle");
        	objChild.set_dragmovetype("all");
        ...
        this.on_initEvent = function()
        {
            ...
            this.Div00.form.Grid01_00.addEventHandler("oncellclick",this.Div00_Grid01_oncellclick,this);
            this.Div00.form.btnSearch00.addEventHandler("onclick",this.btnSearch00_onclick,this);
        };
        this.loadIncludeScript("PTS_6020U_02.xfdl");
