(function()
{
    return function()
    {
        ...
        {
            this.set_name("itemManage_choisw");
            this.set_titletext("제품관리 - 최성웅");
        ...
        // User Script
        this.addIncludeScript("itemManage_choisw.xfdl","lib::common.xjs");
        this.registerScript("itemManage_choisw.xfdl", function() {
        /**
        *  OOO
        *  MenuPath      OOO
        *  FileName      OOO.xfdl
        ...
        ************************************************************************************************/
        ...
        this.loadIncludeScript("itemManage_choisw.xfdl");
