(function()
{
    return function()
    {
        ...
        {
            this.set_name("Popup800");
            this.set_titletext("Popup800");
            if (Form == this.constructor)
            {
                this._setFormPosition(800,620);
            }
            ...
            obj = new Div("Div00","0","0","800","620",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("");
            ...
            obj = new Static("Static04_00_00_01_00","349",null,"103","23",null,"0",null,null,null,null,this.Div00.form);
            obj.set_taborder("4");
            obj.set_text("h 23");
            obj.set_visible("false");
            obj.set_background("aqua");
            ...
            obj = new Static("sch_RQST_NO","20","15","13.51%","26",null,null,null,null,null,null,this.Div00.form.div_Search.form);
            obj.set_taborder("2");
            obj.set_text("<fs v=\'13\'><fc v=\'#ef4343\'>*</fc></fs>신청정보");
            obj.set_cssclass("sta_WF_condition01");
            obj.set_usedecorate("true");
            this.Div00.form.div_Search.addChild(obj.name, obj);

            obj = new Static("sch_RQST_DT","50.00%","15","13.51%","26",null,null,null,null,null,null,this.Div00.form.div_Search.form);
            obj.set_taborder("4");
            obj.set_text("신청일");
            obj.set_cssclass("sta_WF_condition01");
            this.Div00.form.div_Search.addChild(obj.name, obj);

            obj = new Calendar("SCH_RQST_DT","sch_RQST_DT:10","15","118","26",null,null,null,null,null,null,this.Div00.form.div_Search.form);
            obj.set_taborder("5");
            ...
            obj = new Static("sch_LAST_UPT_NM","20","49","13.51%","26",null,null,null,null,null,null,this.Div00.form.div_Search.form);
            obj.set_taborder("8");
            ...
            obj = new Static("sch_LAST_UPT_DT","50.00%","49","13.51%","26",null,null,null,null,null,null,this.Div00.form.div_Search.form);
            obj.set_taborder("9");
            obj.set_text("최종수정일");
            obj.set_cssclass("sta_WF_condition01");
            this.Div00.form.div_Search.addChild(obj.name, obj);
            ...
            obj = new Edit("SCH_RQST_NO","sch_RQST_NO:10","15","178","26",null,null,null,null,null,null,this.Div00.form.div_Search.form);
            obj.set_taborder("3");
            obj.set_maxlength("100");
            obj.set_cssclass("essential");
            this.Div00.form.div_Search.addChild(obj.name, obj);

            obj = new Edit("SCH_LAST_UPT_NM","sch_LAST_UPT_NM:10","49","178","26",null,null,null,null,null,null,this.Div00.form.div_Search.form);
            obj.set_taborder("6");
            obj.set_cssclass("essential");
            this.Div00.form.div_Search.addChild(obj.name, obj);
            ...
            obj = new Static("Static10_00","330","3","40","84",null,null,null,null,null,null,this.Div00.form.div_Search.form);
            obj.set_taborder("10");
            obj.set_text("w40");
            obj.set_visible("false");
            obj.set_background("fuchsia");
            ...
            obj = new Static("Static11","20","0",null,"15","20",null,null,null,null,null,this.Div00.form.div_Search.form);
            obj.set_taborder("11");
            obj.set_text("h 15");
            obj.set_visible("false");
            obj.set_background("aqua");
            ...
            obj = new Static("Static14","20","41",null,"8","20",null,null,null,null,null,this.Div00.form.div_Search.form);
            obj.set_taborder("12");
            obj.set_text("h 8");
            obj.set_visible("false");
            obj.set_background("aqua");
            ...
            obj = new Static("Static15","20","75",null,"15","20",null,null,null,null,null,this.Div00.form.div_Search.form);
            obj.set_taborder("13");
            obj.set_text("h 15");
            obj.set_visible("false");
            obj.set_background("aqua");
            ...
            obj = new Static("Static12","119","15","10","60",null,null,null,null,null,null,this.Div00.form.div_Search.form);
            obj.set_taborder("14");
            obj.set_text("w 10");
            obj.set_visible("false");
            obj.set_background("fuchsia");
            ...
            obj = new Static("Static12_00","469","15","10","60",null,null,null,null,null,null,this.Div00.form.div_Search.form);
            obj.set_taborder("15");
            obj.set_text("w 10");
            obj.set_visible("false");
            obj.set_background("fuchsia");
            ...
            obj = new Div("div_Search02_00","30","175",null,"162","30",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("6");
            ...
            obj = new Static("Static10_00_00_02","20","45",null,"34","20",null,null,null,null,null,this.Div00.form.div_Search02_00.form);
            obj.set_taborder("3");
            ...
            obj = new Static("in_YY","20","111","20.33%","34",null,null,null,null,null,null,this.Div00.form.div_Search02_00.form);
            obj.set_taborder("6");
            obj.set_text("Spinner");
            obj.set_cssclass("sta_WF_condition02_L");
            this.Div00.form.div_Search02_00.addChild(obj.name, obj);

            obj = new Static("Static11_00","20","45","20.33%","34",null,null,null,null,null,null,this.Div00.form.div_Search02_00.form);
            obj.set_taborder("7");
            obj.set_text("신청번호");
            obj.set_cssclass("sta_WF_condition02_L");
            this.Div00.form.div_Search02_00.addChild(obj.name, obj);

            obj = new Static("Static05_00","50.00%","111","20.33%","34",null,null,null,null,null,null,this.Div00.form.div_Search02_00.form);
            obj.set_taborder("8");
            obj.set_text("기간입력");
            obj.set_cssclass("sta_WF_condition02");
            this.Div00.form.div_Search02_00.addChild(obj.name, obj);

            obj = new Static("Static25","50.00%","78","20.33%","34",null,null,null,null,null,null,this.Div00.form.div_Search02_00.form);
            obj.set_taborder("9");
            obj.set_text("readonly");
            obj.set_cssclass("sta_WF_condition02");
            this.Div00.form.div_Search02_00.addChild(obj.name, obj);

            obj = new Static("Static23","20","78","20.33%","34",null,null,null,null,null,null,this.Div00.form.div_Search02_00.form);
            obj.set_taborder("10");
            obj.set_text("콤보입력");
            obj.set_cssclass("sta_WF_condition02_L");
            this.Div00.form.div_Search02_00.addChild(obj.name, obj);

            obj = new Static("Static22","50.00%","45","20.33%","34",null,null,null,null,null,null,this.Div00.form.div_Search02_00.form);
            obj.set_taborder("11");
            obj.set_text("필수입력");
            obj.set_cssclass("sta_WF_condition02");
            this.Div00.form.div_Search02_00.addChild(obj.name, obj);

            obj = new Static("Static00","Static11_00:10","46","186","34",null,null,null,null,null,null,this.Div00.form.div_Search02_00.form);
            obj.set_taborder("12");
            obj.set_text("ACT02202001-00");
            this.Div00.form.div_Search02_00.addChild(obj.name, obj);

            obj = new Static("Static00_00","Static22:10","46","183","34",null,null,null,null,null,null,this.Div00.form.div_Search02_00.form);
            obj.set_taborder("13");
            obj.set_text("ACT02202001-00");
            this.Div00.form.div_Search02_00.addChild(obj.name, obj);

            obj = new Static("Static00_00_00","in_YY:10","112","185","34",null,null,null,null,null,null,this.Div00.form.div_Search02_00.form);
            obj.set_taborder("14");
            obj.set_text("ACT02202001-00");
            this.Div00.form.div_Search02_00.addChild(obj.name, obj);

            obj = new Static("Static00_00_01","Static25:10","79","183","34",null,null,null,null,null,null,this.Div00.form.div_Search02_00.form);
            obj.set_taborder("15");
            obj.set_text("ACT02202001-00");
            this.Div00.form.div_Search02_00.addChild(obj.name, obj);

            obj = new Static("Static00_00_00_00","Static05_00:10","112","183","34",null,null,null,null,null,null,this.Div00.form.div_Search02_00.form);
            obj.set_taborder("16");
            obj.set_text("ACT02202001-00");
            this.Div00.form.div_Search02_00.addChild(obj.name, obj);

            obj = new Static("Static00_01","Static23:10","79","185","34",null,null,null,null,null,null,this.Div00.form.div_Search02_00.form);
            obj.set_taborder("17");
            obj.set_text("ACT02202001-00");
            this.Div00.form.div_Search02_00.addChild(obj.name, obj);

            obj = new Static("Static10_00",null,"0","20",null,"0","0",null,null,null,null,this.Div00.form.div_Search02_00.form);
            obj.set_taborder("18");
            obj.set_text("w20");
            obj.set_visible("false");
            obj.set_background("fuchsia");
            ...
            obj = new Div("div_Search02_00_00","30","347",null,"197","30",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("7");
            obj.set_cssclass("div_WF_popup");
            obj.set_text("");
            this.Div00.addChild(obj.name, obj);
            ...
            obj = new Static("Static04_00_00_01_00_00","349",null,"103","25",null,"51",null,null,null,null,this.Div00.form);
            obj.set_taborder("8");
            obj.set_text("h 25");
            obj.set_visible("false");
            obj.set_background("aqua");
            ...
            obj = new Button("btn_popClose",null,null,"65","28","367","23",null,null,null,null,this.Div00.form);
            obj.set_text("닫기");
            obj.set_cssclass("");
            ...
            obj = new Static("Static07","30","337","80","10",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("10");
            obj.set_text("h 10");
            obj.set_visible("false");
            obj.set_background("aqua");
        ...
        this.loadIncludeScript("pat_popup800.xfdl");
